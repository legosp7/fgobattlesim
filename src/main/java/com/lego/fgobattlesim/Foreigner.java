...
public class Foreigner extends Servant {

    private String className = "Foreigner";
    

    

    public Foreigner(String name, int id, int rarity, int cost, int lvl_1_atk, int lvl_1_hp,
